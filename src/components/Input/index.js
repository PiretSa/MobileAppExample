...
import { TextInput, Text, View, Pressable, Image, Modal, TouchableOpacity } from "react-native";
import { styles } from "./styles";

const Input = ({label, placeholder, isPassword, options, value, onChangeText, type, ...props}) => {
